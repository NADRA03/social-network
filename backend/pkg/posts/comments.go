...
http.Error(w, "Missing content or Image", http.StatusBadRequest)
return
}
...
VALUES (?, ?, ?, ?)
`, input.PostID, userID, input.Content, input.Image)
...
for rows.Next() {
var id int
var content, imageURL, username string
var createdAt time.Time

if err := rows.Scan(&id, &content, &imageURL ,&createdAt, &username); err != nil {
